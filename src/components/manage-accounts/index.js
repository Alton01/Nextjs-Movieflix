...
export default function ManageAccounts() {
    ...
    // FOR GETTING ALL ACCOUNTS LINKED TO A USER
...
// FOR SAVING MULTIPLE ACCOUNTS UNDER ONE USER
...
// FOR REMOVING AN ACCOUNT FROM A USER'S LIST OF ACCOUNT
...
// FOR SUBMISSION OF PIN PER INDIVIDUAL ACCOUNT LOGIN
    ...
    return <div className="min-h-screen flex justify-center flex-col items-center relative">
        <div className="flex justify-center flex-col items-center">
            ...
            <div className="text-center">
                <span onClick={() => setShowDeleteIcon(!showDeleteIcon)} className="border border-gray-100 cursor-pointer tracking-wide inline-flex text-sm px-[15px] py-[15px]">
                  Manage Profiles
                </span>
            </div>
        </div>
        <PinContainer pin={pin} setPin={setPin} pinError={pinError} setPinError={setPinError} showPinContainer={showPinContainer.show} setShowPinContainer={setShowPinContainer} handlePinSubmit={handlePinSubmit} />
