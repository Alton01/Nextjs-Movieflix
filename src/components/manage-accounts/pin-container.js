...
export default function PinContainer({
    ...
    return ( 
        ...
        <div className="z-[100] bg-[#141414] flex-col min-h-screen absolute left-0 top-0 justify-center flex items-center right-0">
            ...
            <h1 className="text-gray-400 font-bold text-[16px] mb-4">Profile Lock Is Currently On</h1>
            {
                pinError ?
                <h2 className="text-[#e6b209] font-bold text-[30px]">Wrong Pin. Please try again.</h2> 
