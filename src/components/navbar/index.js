...
export default function Navbar () {
    ...
    const {setPageLoader, loggedInAccount, setAccounts, accounts, setLoggedInAccount, pageLoader, showDetailsPopup, setShowDetailsPopup} = useContext(GlobalContext);
                ...
                <div className="font-light flex items-center space-x-4 text-sm">
                    {
                        ...
                        /> 
                        ) : ( <AiOutlineSearch onClick={() => setShowSearchBar(true)}
