...
export default function Search ({pathName, router, searchQuery, setSearchQuery, setPageLoader, setShowSearchBar})
 {
    ...
    return <div className="hidden md:flex justify-center items-center text-center">
                <div className="bg-[rgba(0,0,0,0.75)] border border-[hsla(0,0%,100%,0,0.5)] px-4 items-center text-center flex">
                    <div className="order-2">
                        ...
                        placeholder="Search Movies, TV & Drama"
